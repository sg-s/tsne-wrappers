function [yData,betas,P,errors] = fit(data,varargin)
% run_tSne runs the t-SNE algorithm on input array
...
D = TSNE.berman.findKLDivergences(data);


fprintf(1,'Computing t-SNE\n');
[yData,betas,P,errors] = TSNE.berman.fit_d(D,options);